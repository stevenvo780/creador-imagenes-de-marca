...
def _validate_taxonomy_root(data: Any) -> dict[str, Any]:
    """Validate root structure and conventions."""
...
def _validate_category(
    family_name: str, category_name: str, category: Any, conventions: dict[str, Any]
) -> None:
...
def _validate_type(
    ...
    for variant_idx, variant in enumerate(variants):
        _validate_variant(
            family_name, category_name, name, where, variant_idx, variant, seen_variants
        )
...
def _validate_variant(
    ...
    if vid in seen_variants:
        raise ValueError(f"variant duplicada en {family_name}/{category_name}/{type_name}: {vid!r}")
...
def validate_taxonomy(data: Any) -> None:
    ...
    """
    families = _validate_taxonomy_root(data)
    ...
    for family_name, family in families.items():
        ...
        for category_name, category in categories.items():
            _validate_category(family_name, category_name, category, conventions)
