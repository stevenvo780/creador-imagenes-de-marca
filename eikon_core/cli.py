...
Ejemplos:
  ...
  python web_icons.py --all
    ...
    parser.add_argument("--resume", "--solo-cambios", action="store_true", dest="resume", help="Usa cache para saltar assets no modificados")
    ...
    parser.add_argument("--clean", action="store_true", help="Limpia output/<marca>/ antes de renderizar (opt-in)")
    parser.add_argument("--fail-on-layout", action="store_true", help="Exit 1 si algún asset tiene layout_status=fail")
    parser.add_argument("--web-icons", action="store_true", help="Genera favicon/PWA/OG tras render Playwright")
