...
ALGORITHMS: list[tuple[str, str, str, str]] = [
    ...
    (
        ...
        "Polígonos anidados",
        "Polígonos",
        "k polígonos concéntricos decrecientes",
    ),
    ...
    (
        ...
        "Inicial en círculo",
        "Tipográfico",
        "inicial centrada con texto circular alrededor",
    ),
    # ── Emblemas ─────────────────────────────────────────────────────────────
    ...
    (
        ...
        "Marca geométrica",
        "Geométricas",
        "2-3 formas simples combinadas por seed",
    ),
    ...
    (
        ...
        "Monograma reticulado",
        "Tipográfico",
        "inicial sobre retícula 5x5 estilo Bauhaus",
    ),
    (
        "negativo_espacio",
        "Espacio negativo",
        "Tipográfico",
        "inicial recortada en forma sólida (FedEx/Roche)",
    ),
    (
        "icono_inicial",
        "Ícono + inicial",
        "Tipográfico",
        "ícono geométrico simple + inicial alineados",
    ),
]
